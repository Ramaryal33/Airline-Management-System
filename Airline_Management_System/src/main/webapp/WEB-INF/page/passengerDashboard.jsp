...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/passenger.css">
</head>
<body>
    <!-- Sidebar Section -->
    <div class="sidebar">
        <!-- Use context path for images -->
        <img src="${pageContext.request.contextPath}/image/plane.png" alt="Airline Logo" class="logo">
        <nav>
    ...
    <div class="main">
        ...
        <div class="welcome">
            <h2>Welcome, ${user.fullName}!</h2>  <!-- ✅ Correct -->
        ...
        <div class="planning-journey">
            ...
            <div class="planning-form">
                <h3>Where To?</h3>
                <p>Book a Flight</p>
                <img src="${pageContext.request.contextPath}/image/plane.png" alt="Plane Illustration">
